...
- **[setup](./003-usage.md#initialize-configuration-files)**: Interactively create a profile configuration with basic settings
- **[run](./003-usage.md#start-all-tools-and-automation)**: Start all tools and automation for your speedrun session
- **[destroy](./003-usage.md#remove-keybinds-and-stop-kanata--input-remapping)**: Stop automation and clean up keybinds
